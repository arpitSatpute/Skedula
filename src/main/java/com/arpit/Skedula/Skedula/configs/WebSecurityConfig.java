...
public class WebSecurityConfig {
    ...
    private static final String[] PUBLIC_ROUTES = {"/auth/**", "/actuator/health", "/v2/api-docs/**", "/v3/api-docs/**", "/swagger-ui/**", "/swagger-ui.html", "/public/**", "/h2-console/**", "/razorpay/pay", "/payment.html"};
